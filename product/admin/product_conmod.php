...
?> 
		  ...
		  <tr> 
            <td height="30" width="100" align="center" ><?php echo $strProductAddImg; ?></td>
            <td height="30" > 
              <input id="uppic" type="file" name="jpg" class="input" style='WIDTH: 499px;' />
			  <input  type='submit' name='modi' onClick="KindSubmit();" value='<?php echo $strProductUpload; ?>' class='savebutton' />
		    </td>
          </tr>
	...
	<div id="proplist" class="productmodizone">
		 ...
		 <tr>
		  ...
		  <tr>
      <td height="30" width="100" align="center" ><?php echo $strProductAddCon; ?></td>
      <td height="30" > 
         <input type="hidden" name="body" value="<?php echo $body; ?>" />
			...
			editor.imageAttachPath="product/pics/";
