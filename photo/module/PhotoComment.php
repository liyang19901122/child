...
function PhotoComment(){
	...
	global $fsql,$tsql,$strGuest;
		...
		$scl=" iffb='1' and catid='2' and pid='0' and rid='$photoid' ";

		$moreurl=ROOTPATH."comment/class/index.php?catid=2&rid=".$photoid;
		...
		//获取标题
		$tsql->query("select title from {P}_photo_con where id='$photoid'");
		if($tsql->next_record()){
			$title=$tsql->f("title");
		}
